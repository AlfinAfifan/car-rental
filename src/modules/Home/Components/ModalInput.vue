    ...
    <div class="modal-box flex flex-col gap-5">
      ...
      <div class="grid grid-cols-2 gap-5">
        <div>
          ...
          <input v-model="dataInput.start_date" id="mulai" type="date" placeholder="Type here" class="input input-bordered w-full" />
        </div>
        <div>
          <label for="end">Tanggal Pengembalian</label>
          <input v-model="dataInput.end_date" id="end" type="date" placeholder="Type here" class="input input-bordered w-full" />
        </div>
      </div>
